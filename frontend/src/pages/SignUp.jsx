...
function SignUp() {
  ...
  return (
    ...
    >
      <form
        className="w-[90%] h-[600px] max-w-[500px] bg-[#0000005c] backdrop-blur-sm shadow-lg shadow-black-950 flex flex-col items-center justify-center gap-[20px] px-[20px]"
      ...
      >
        ...
        <button
          className="min-w-[120px] h-[40px] mt-[15px] bg-white text-black font-semibold text-[18px] rounded-full"
          disabled={loading}
        >
